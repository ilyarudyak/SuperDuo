...
public class ScoresAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        mHolder.score.setText(MiscUtils.getScores(cursor.getInt(COL_HOME_GOALS),
        ...
        mHolder.homeCrest.setContentDescription(context
                .getString(R.string.a11y_home_team_crest, homeName));
        mHolder.awayCrest.setContentDescription(context
                .getString(R.string.a11y_away_team_crest, awayName));
        ...
        if (mHolder.matchId == detailMatchId) {
            ...
            TextView match_day = (TextView) v.findViewById(R.id.match_day_text_view);
